...
export class HotelsService {
  ...
  public setCurrentHotel: Subject<Hotel> = new Subject<Hotel>();
  ...
  public changeHotel(chooseHotel: Hotel): void {
    console.info(11);
    this.setCurrentHotel.next(chooseHotel);
  }

  public checkChangeHotel = this.setCurrentHotel.subscribe((value) => {
    console.info(value);
